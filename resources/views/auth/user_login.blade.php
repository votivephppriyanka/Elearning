...
<div class="cont">
  <div class="form sign-in">
    ...
    <div id="loginmsg"></div>
    <form  id="loginForm" method="POST" name="loginForm" action="javascript:void(0)">
    ...
    <button type="submit" id="login_sub" class="submit">Sign In</button>
  </form>
  ...
  <div class="sub-cont">
    <div class="img">
      <div class="img__text m--up">
        ...
        <h2>New here?</h2>
        <p>Sign up and discover great Tutors of new Courses!</p>
      </div>
      <!-- <div class="img__text m--in">
      	<span><img src="{{ url('public/img/logo.png') }}"></span>
        <h2>One of us?</h2>
        <p>If you already has an account, just sign in. We've missed you!</p>
      </div> -->
      <a href="registration"><div class="img__btn">
        <span class="m--up">Sign Up</a></span>
      ...
      $.ajax({
        ...
        success: function( response ) {
            ...
            if(response.status==false){
              $('#loginmsg').html('<p style="text-align:center;color:red">'+response.msg+'</p>');
            }else{
              $('#loginmsg').html('<p style="text-align:center;color:green">'+response.msg+'</p>');
            }
            //$('#msg_div').removeClass('d-none');
            if(response.user_role==2){
              document.getElementById("loginForm").reset(); 
              setTimeout(function(){
                window.location.href = site_url+"/tutor/dashboard";
              },2000);
          }

...
<body>
  ...
  <div class="form sign-in">
    ...
    <h2>Tutor Sign Up</h2>
    <div id="msg"></div>
    <form  id="tutorsForm" method="POST" name="tutorsForm" action="javascript:void(0)">
    ...
    <label>
      ...
      <select id="code" name="code" class="@error('contact_number') is-invalid @enderror">
        @foreach($country_code as $code)
            <option value="+{{$code->phonecode}}">{{$code->iso}} +{{$code->phonecode}}</option>
        @endforeach
      </select>
    <input id="contact_number" type="contact_number" class="@error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number') }}"  autocomplete="contact_number">
    </label>
    ...
    <button type="submit" id="tt_btn" class="submit">Sign Up</button>
  </form>

        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title pull-right"><a href="{{url('/admin/add_grade')}}" class="btn btn-primary">Add</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <tr id="row{{$arr->id}}">
                    ...
                    <td>
                      ...
                      <a href="{{url('/admin/edit_grade')}}/{{base64_encode($arr->id)}}"><i class="fa fa-edit" aria-hidden="true" alt="edit" title="edit"></i></a>

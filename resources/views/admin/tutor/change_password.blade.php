     ...
     @endif
      ...
      <div class="row">
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
          <form action="{{url('/admin/update_tutor_password')}}" id="changePasswordForm" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="_token" id="csrf-token" value="{{csrf_token()}}" />
            <input type="hidden" name="tutor_id" value="{{(!empty($tutor_info->id) ? $tutor_info->id : '')}}" />
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">

        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tutors List</h3>
              <h3 class="box-title pull-right"><a href="{{url('/admin/add_tutor')}}" class="btn btn-primary">Add Tutor</a></h3>
              <h3 class="box-title pull-right"><a class="btn btn-primary" href="{{ url('/admin/TutorExportData') }}">Export Tutor Data</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form action="{{ url('admin/TutorImportData') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  @csrf
                <div class="col-md-2">
              ...
              <table id="tutor_list" class="table table-bordered table-striped">
                ...
                <tbody>
                  @if(!$tutor_list->isEmpty())
                  <?php $i=1; ?>
                  @foreach($tutor_list as $arr)
                  <tr id="row{{$arr->id}}">
                    <td>{{$i}}</td>
                    ...
                    <td>
                      ...
                      <a href="{{url('/admin/change_tutor_password')}}/{{base64_encode($arr->id)}}">Update Password</a>

                      <a href="{{url('/admin/edit_tutor')}}/{{base64_encode($arr->id)}}"><i class="fa fa-edit" aria-hidden="true" alt="edit" title="edit"></i></a>

                      <a href="javascript:void(0)" onclick="delete_tutor('<?php echo $arr->id; ?>');"><i class="fa fa-trash" aria-hidden="true" alt="delete" title="delete"></i></a>
